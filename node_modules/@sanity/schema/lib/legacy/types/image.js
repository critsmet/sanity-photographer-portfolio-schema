...
const ImageType = {
  ...
  extend(subTypeDef, extendMember) {
    ...
    let hotspotFields = [_fieldDefs.HOTSPOT_FIELD, _fieldDefs.CROP_FIELD];
    ...
    const fields = (subTypeDef.fields || []).concat(_fieldDefs.ASSET_FIELD).concat(hotspotFields);
    const parsed = Object.assign((0, _pick2.default)(IMAGE_CORE, OVERRIDABLE_FIELDS), subTypeDef, {
      type: IMAGE_CORE,
