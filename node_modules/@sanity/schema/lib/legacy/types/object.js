...
var _resolveSearchFieldPaths = _interopRequireDefault(require("../resolveSearchFieldPaths"));
...
const OVERRIDABLE_FIELDS = ['jsonType', 'orderings', 'type', 'name', 'title', 'readOnly', 'hidden', 'description', '__unstable_searchFields', 'options', 'inputComponent', 'validation'];
const ObjectType = {
  get() {
    return {
      name: 'object',
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    (0, _utils.lazyGetter)(parsed, '__unstable_searchFields', () => (0, _resolveSearchFieldPaths.default)(parsed), {
      enumerable: false
    });
