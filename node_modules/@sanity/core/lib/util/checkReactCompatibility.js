...
const deprecated = {// add packages to deprecate support for here
};
...
module.exports = workDir => {
  ...
  Object.keys(supported).forEach(pkg => {
    ...
    if (semver.satisfies(installed, deprecated[pkg])) {
      console.warn(`[WARN] ${pkg} ${deprecated[pkg]} is deprecated and will be unsupported in an upcoming release of Sanity. Please upgrade the ${pkg} package. Read more at ${generateHelpUrl('upgrade-package')} `);
    }
