...
PartResolverPlugin.prototype.apply = function (compiler) {
  ...
  compiler.plugin('compilation', () => {
    compiler.resolvers.normal.plugin('module', function (request, callback) {
      ...
      const sanityPart = request.request.replace(/^all:/, ''); // The debug part should return the whole part/plugin tree
      ...
      const part = parts.implementations[sanityPart]; // Imports throw if they are not implemented, except if they
