...
function getDevServer(config = {}) {
  ...
  const webpackConfig = config.webpack || (0, _webpackConfig.default)(config); // Serve an empty CSS file for the main stylesheet,
  ...
  (0, _register.default)(); // Apply the dev and hot middlewares to build/serve bundles on the fly
