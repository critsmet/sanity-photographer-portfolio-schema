...
class ProgressBar extends _react.default.Component {
  render() {
    ...
    const rootClasses = `
      ${isComplete ? _barStyle.default.completed : _barStyle.default.uncompleted}
      ${percent >= 100 && _barStyle.default.hundredPercent}
      ${isInProgress ? _barStyle.default.isInProgress : _barStyle.default.isNotInProgress}
    `;
    const barStyle = {
      width: `${percent}%`
    };
