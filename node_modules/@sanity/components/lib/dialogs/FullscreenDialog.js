...
class FullScreenDialog extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "handleActionClick", event => {
  ...
  render() {
    ...
    const classNames = [_fullscreenStyle.default[color] || _fullscreenStyle.default.default, isOpen ? _fullscreenStyle.default.isOpen : _fullscreenStyle.default.isClosed, className, centered && _fullscreenStyle.default.centered].filter(Boolean).join(' ');
    ...
    }, actions.length > 0 && _react.default.createElement(_buttonCollection.default, {
      align: "start",
