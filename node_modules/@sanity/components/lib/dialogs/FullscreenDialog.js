...
class FullScreenDialog extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "renderActions", actions => {
      ...
      const _partition2 = (0, _partition4.default)(actions, action => action.secondary),
            _partition3 = _slicedToArray(_partition2, 2),
            secondary = _partition3[0],
            primary = _partition3[1];

      return _react.default.createElement(_buttonCollection.default, {
        align: "end",
  ...
  render() {
    ...
    const classNames = [_fullscreenStyle.default[color] || _fullscreenStyle.default.default, isOpen ? _fullscreenStyle.default.isOpen : _fullscreenStyle.default.isClosed, centered && _fullscreenStyle.default.centered, className].filter(Boolean).join(' ');
    return _react.default.createElement(_StackedEscapable.default, {
      ...
      className: _fullscreenStyle.default[`padding_${padding}`]
