...
const paragraphs = (0, _range2.default)(0, 20).map(i => _react.default.createElement("p", {
  key: i
}, chance.paragraph()));
...
(0, _storybook.storiesOf)('Dialogs').addDecorator(_knobs.withKnobs).add('Default', () => {
  ...
  const dialogActions = (0, _knobs.boolean)('Show actions', false, 'test') ? actions : [];
  const contentTest = (0, _knobs.select)('content', dialogTestContent, 'minimal');
  ...
  const dialogActions = (0, _knobs.boolean)('Include actions', false, 'test') ? actions : [];
  const contentTest = (0, _knobs.select)('content', dialogTestContent, 'minimal');
  return _react.default.createElement(_sanity.default, {
  ...
  const left = (0, _knobs.number)('Reference left', 50, percentRange, 'test');
  const top = (0, _knobs.number)('Reference top', 50, percentRange, 'test');
  const width = (0, _knobs.number)('Reference width', 150, sizeRange, 'test');
  const height = (0, _knobs.number)('Reference height', 150, sizeRange, 'test');
  const placement = (0, _knobs.select)('Placement', ['auto', 'top', 'right', 'bottom', 'left', 'auto-start', 'top-start', 'right-start', 'bottom-start', 'left-start', 'auto-end', 'top-end', 'right-end', 'bottom-end', 'left-end'], 'auto', 'props');
  const refStyles = {
    position: 'absolute',
    top: `${top}%`,
    left: `${left}%`,
  ...
  return _react.default.createElement(_sanity.default, {
    ...
    color: (0, _knobs.select)('color', [undefined, 'danger', 'success', 'info', 'warning'], undefined, 'props'),
