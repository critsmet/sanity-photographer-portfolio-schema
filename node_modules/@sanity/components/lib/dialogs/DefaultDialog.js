...
class DefaultDialog extends _react.default.PureComponent {
  ...
  render() {
    ...
    const contentHasOverflow = this.state.contentHasOverflow;
    const classNames = `
      ${_defaultStyle.default.root}
      ${_defaultStyle.default[color]}
      ${actions && actions.length > 0 ? _defaultStyle.default.hasFunctions : ''}
      ${className}
    `;
