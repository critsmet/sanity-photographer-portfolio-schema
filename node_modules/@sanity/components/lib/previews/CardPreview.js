...
const fieldProp = _propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.node, _propTypes.default.func]);
...
class CardPreview extends _react.default.PureComponent {
  ...
  render() {
    ...
    return _react.default.createElement("div", {
      ...
      layout: 'default'
    }) || status), date && _react.default.createElement("div", {
      ref: this.setDateElement,
      className: _cardStyle.default.date,
      title: (0, _format.default)(date, 'ddd, MMM Do, YYYY hh:mm A')
    }, emWidth <= 10 && (0, _format.default)(date, 'DD.MM.YY'), emWidth > 10 && emWidth <= 15 && (0, _format.default)(date, 'DD.MM.YY hh:mm A'), emWidth > 15 && (0, _format.default)(date, 'ddd, MMM Do, YYYY hh:mm A'))), subtitle && _react.default.createElement("h3", {
      className: _cardStyle.default.subtitle
