...
function createButtonLike(Component, {
  displayName,
  defaultProps = {}
}) {
  var _class, _temp;
  ...
  return _temp = _class = class ButtonLike extends _react.default.Component {
    ...
    render() {
      const _this$props = this.props,
            ...
            rest = _objectWithoutProperties(_this$props, ["kind", "ripple", "inverted", "color", "icon", "loading", "className", "children", "padding"]); // Should not be part of the destructing, cause it should be passed to component through rest


      const disabled = this.props.disabled;
      const style = (0, _classnames.default)(className, [_defaultStyle.default.root, _defaultStyle.default[kind], _defaultStyle.default[`padding_${padding}`], inverted && _defaultStyle.default.inverted, color && _defaultStyle.default[`color__${color}`], disabled && _defaultStyle.default.disabled, !children && _defaultStyle.default.onlyIcon]);
      ...
      }, children), ripple && !disabled && _react.default.createElement(_reactInk.default, {
        duration: 1000,
        opacity: 0.1,
        radius: 200
      })));
  ...
  }, _defineProperty(_class, "displayName", displayName || `ButtonLike(${typeof Component === 'string' ? Component : Component.displayName || Component.name})`), _defineProperty(_class, "propTypes", {
