...
class InInputButton extends _react.default.Component {
  ...
  render() {
    ...
    const style = `
      ${className || ''}
      ${inverted && _inInputStyle.default.inverted || ''}
      ${_inInputStyle.default[kind] ? _inInputStyle.default[kind] : _inInputStyle.default.root}
      ${colored && _inInputStyle.default.colored ? _inInputStyle.default.colored : ''}
      ${Icon && _inInputStyle.default.hasIcon ? _inInputStyle.default.hasIcon : ''}
    `;
