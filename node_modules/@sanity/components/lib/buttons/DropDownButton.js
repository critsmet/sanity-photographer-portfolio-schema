  ...
  customStyle: {
    ...
    fn: data => {
      data.styles = _objectSpread({}, data.styles, {
        minWidth: `${(0, _get2.default)(data, 'offsets.reference.width' || 100)}px`
      });
      return data;
    }
  }
...
class DropDownButton extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "handleItemClick", item => {
  ...
  render() {
    const _omit2 = (0, _omit3.default)(this.props, 'onAction'),
          ...
          rest = _objectWithoutProperties(_omit2, ["items", "renderItem", "children", "kind", "className", "placement"]);
    ...
    return _react.default.createElement(_poppable.default, {
      modifiers: modifiers,
      placement: placement,
      target: target,
