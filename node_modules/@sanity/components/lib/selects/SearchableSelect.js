...
class SearchableSelect extends _react.default.PureComponent {
  constructor(props) {
    ...
    const _inputValue = props.inputValue;
    this.state = {
  ...
  render() {
    ...
    const _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["onSearch"]);

    return _react.default.createElement("div", {
      ref: this.setRootElement
    }, _react.default.createElement(_StatelessSearchableSelect.default, _extends({}, rest, {
