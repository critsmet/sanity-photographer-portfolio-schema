...
class StatelessSearchableSelect extends _react.default.PureComponent {
  ...
  render() {
    ...
    return _react.default.createElement(_reactPopper.Manager, null, _react.default.createElement(_reactPopper.Reference, null, ({
    ...
    }, openItemElement(value)), onClear && value && _react.default.createElement("button", {
      type: "button",
    ...
    }, _react.default.createElement(_spinner.default, null)))))), isOpen && _react.default.createElement(_Stacked.default, null, isActive => _react.default.createElement(_Portal.Portal, null, _react.default.createElement(_reactPopper.Popper, {
      placement: "bottom",
      modifiers: {
        preventOverflow: {
        ...
        customStyle: {
          enabled: true,
          fn: data => {
            const width = (0, _get2.default)(data, 'instance.reference.clientWidth') || 500;
      ...
      className: _searchableStyle.default.listContainer
    }, _react.default.createElement(_Escapable.default, {
      onEscape: event => (isActive || event.shiftKey) && this.handleClose()
    }), items.length === 0 && !isLoading && _react.default.createElement("p", {
      className: _searchableStyle.default.noResultText
    }, "No results"), items.length === 0 && isLoading && _react.default.createElement("div", {
      className: _searchableStyle.default.listSpinner
    }, _react.default.createElement(_spinner.default, {
      message: "Loading items\u2026"
    })), items.length > 0 && _react.default.createElement(_SelectMenu.default, {
      items: items,
      value: value,
