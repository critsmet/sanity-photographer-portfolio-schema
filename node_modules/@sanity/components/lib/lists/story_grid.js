...
class SortableGridTester extends _react.default.Component {
  constructor(props, args) {
    ...
    _defineProperty(this, "handleOnSort", ({
      oldIndex,
      newIndex
    }) => {
...
(0, _storybook.storiesOf)('List (grid)').addDecorator(_knobs.withKnobs).add('MediaPreview', () => {
  const items = (0, _range2.default)(50).map((item, i) => {
    const width = (0, _random2.default)(10, 80) * 10;
    const height = (0, _random2.default)(10, 50) * 10;
