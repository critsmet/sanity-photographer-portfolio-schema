...
function createSortableList(element) {
  ...
  return class SortableList extends _react.default.Component {
    constructor(...args) {
      super(...args);
    ...
    render() {
      ...
      return _react.default.createElement(Sortable, _extends({}, rest, {
...
function createSortableItem(element) {
  const Sortable = (0, _reactSortableHoc.SortableElement)(element); // Delegate to SortableElement from react-sortable-hoc
  ...
  return function SortableItem(props) {
    ...
    return _react.default.createElement(Sortable, _extends({
      index: index
    }, rest));
  };
}
