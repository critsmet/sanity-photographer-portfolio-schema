  ...
  render() {
    ...
    return _react.default.createElement("label", {
      className: `
          ...
          ${disabled ? _defaultStyle.default.isDisabled : ''}
          ${checked ? _defaultStyle.default.isChecked : _defaultStyle.default.unChecked}
          ${hasFocus ? _defaultStyle.default.isFocused : ''}
        `,
