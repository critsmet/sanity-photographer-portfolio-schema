...
function (_React$PureComponent) {
  ...
  function HotspotImage() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setImageElement", function (el) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setContainerElement", function (el) {
