...
function (_React$PureComponent) {
  ...
  function ImageTool() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDragStart", function (_ref) {
      var x = _ref.x,
          y = _ref.y;
      var mousePosition = {
        x: x * _this.getScale(),
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDrag", function (pos) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDragEnd", function (pos) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setCanvas", function (node) {
      _this.canvas = node;
    });
  ...
  _createClass(ImageTool, [{
    ...
    value: function getActiveCropHandleFor(_ref2) {
      var x = _ref2.x,
          y = _ref2.y;
