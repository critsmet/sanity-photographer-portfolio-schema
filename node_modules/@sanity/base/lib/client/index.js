...
const apiConfig = _objectSpread({}, _configSanity.default.api, {
  withCredentials: true,
  useCdn: false
});

const client = (0, _client.default)(apiConfig);
const configuredClient = _configureClient.default ? (0, _configureClient.default)((0, _client.default)(apiConfig)) : client; // Warn when people use `.default`
