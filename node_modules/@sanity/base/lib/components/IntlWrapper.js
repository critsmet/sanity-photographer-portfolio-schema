...
const formatDate = proxies.formatDate;
exports.formatDate = formatDate;
const formatTime = proxies.formatTime;
exports.formatTime = formatTime;
const formatNumber = proxies.formatNumber;
exports.formatNumber = formatNumber;
const formatPlural = proxies.formatPlural;
exports.formatPlural = formatPlural;
const formatRelative = proxies.formatRelative;
exports.formatRelative = formatRelative;

const formatHTMLMessage = (desc, values) => {
...
const formatMessage = (desc, values) => {
