...
const fetch = (query, params) => (0, _rxjs.defer)(() => _client.default.observable.fetch(query, params));

const listen = (query, params) => (0, _rxjs.defer)(() => _client.default.listen(query, params, {
...
const listenQuery = (query, params) => {
  const fetchOnce$ = fetch(query, params);
  const events$ = listen(query, params).pipe((0, _operators.share)());
