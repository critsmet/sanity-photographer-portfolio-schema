...
class Preview extends _react.default.Component {
  render() {
    ...
    const PreviewComponent = (0, _previewResolver.default)(type);

    if (!PreviewComponent) {
      return _react.default.createElement("div", null, "No preview for ", JSON.stringify(value));
    }

    return _react.default.createElement(PreviewComponent, {
      type: type,
      value: value,
      layout: layout
    });
