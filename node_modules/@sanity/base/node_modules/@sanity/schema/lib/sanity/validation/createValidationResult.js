...
const error = (message, helpId, path) => createValidationResult('error', message, helpId);

exports.error = error;

const warning = (message, helpId, path) => createValidationResult('warning', message, helpId);

exports.warning = warning;

const info = (message, helpId, path) => createValidationResult('info', message, helpId);
