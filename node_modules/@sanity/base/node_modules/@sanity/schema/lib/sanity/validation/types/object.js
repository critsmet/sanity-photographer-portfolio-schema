...
function validateFieldName(name) {
  if (typeof name !== 'string') {
    return [(0, _createValidationResult.error)(`Field names must be strings. Saw "${(0, _inspect.default)(name)}"`, _createValidationResult.HELP_IDS.OBJECT_FIELD_NAME_INVALID)];
  }
...
var _default = (typeDef, visitorContext) => {
  ...
  return _objectSpread({}, typeDef, {
    fields: (fieldsIsArray ? typeDef.fields : []).map(field => {
      ...
      const _visitorContext$visit = visitorContext.visit(fieldTypeDef, visitorContext),
