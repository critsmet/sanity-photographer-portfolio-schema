...
function () {
  ...
  _createClass(Document, [{
    ...
    value: function considerIncoming() {
      ...
      var nextMut; // Filter mutations that are older than the document
      ...
      if (this.incoming.length > 0 && _debug.default.enabled) {
        (0, _debug.default)('Unable to apply mutations %s', this.incoming.map(function (mut) {
    ...
    value: function applyIncoming(mut) {
      ...
      if (this.anyUnresolvedMutations()) {
        ...
        if (_debug.default.enabled) {
          ...
          (0, _debug.default)("Submitted txnIds: ".concat(this.submitted.map(function (m) {
            return m.transactionId;
          }).join(', ')));
          (0, _debug.default)("Pending txnIds: ".concat(this.pending.map(function (m) {
            return m.transactionId;
          }).join(', ')));
