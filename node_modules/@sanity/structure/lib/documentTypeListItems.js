...
function getDocumentTypeListItem(name, schema = Schema_1.defaultSchema) {
...
function getDocumentTypeList(typeName, schema = Schema_1.defaultSchema) {
    ...
    return new DocumentList_1.DocumentListBuilder()
        .id(typeName)
        .title(title)
        .filter('_type == $type')
        ...
        .canHandleIntent((intentName, params) => Boolean(intentName === 'edit' && params && params.id && params.type === typeName) ||
