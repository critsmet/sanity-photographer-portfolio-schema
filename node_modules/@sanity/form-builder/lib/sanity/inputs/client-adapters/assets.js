...
function uploadSanityAsset(assetType, file, options = {}) {
  ...
  (0, _rxjs.of)(null)), (0, _operators.mergeMap)(hash => hash ? fetchExisting(`sanity.${assetType}Asset`, hash) : (0, _rxjs.of)(null)), (0, _operators.mergeMap)(existing => {
    if (existing) {
      return (0, _rxjs.of)({
...
const uploadImageAsset = (file, options) => uploadAsset('image', file, options);

exports.uploadImageAsset = uploadImageAsset;

const uploadFileAsset = (file, options) => uploadAsset('file', file, options);
