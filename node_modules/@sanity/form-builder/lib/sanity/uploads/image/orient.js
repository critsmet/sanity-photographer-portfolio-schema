...
const ORIENTATIONS = ['top-left', 'top-right', 'bottom-right', 'bottom-left', 'left-top', 'right-top', 'right-bottom', 'left-bottom'];
const DEFAULT_ORIENTATION = 'top-left';
exports.DEFAULT_ORIENTATION = DEFAULT_ORIENTATION;
const THUMB_SIZE = 120; // Based on github.com/component/exif-rotate
...
function _orient(img, orientationNumber) {
  ...
  const ctx = canvas.getContext('2d'); // dims
