...
const SKIP_EXIF_ERROR_RE = /(invalid image format)|(No exif data)/i; // 128k should be enough for exif data according to https://github.com/mattiasw/ExifReader#tips
