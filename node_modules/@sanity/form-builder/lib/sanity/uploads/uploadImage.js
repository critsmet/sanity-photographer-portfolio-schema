...
function uploadImage(file, options) {
  const upload$ = (0, _assets.uploadImageAsset)(file, options).pipe((0, _operators.filter)(event => event.stage !== 'download'), (0, _operators.map)(event => _objectSpread({}, event, {
  ...
  const setPreviewUrl$ = (0, _readExif.default)(file).pipe((0, _operators.mergeMap)(exifData => (0, _rotateImage.default)(file, exifData.orientation || _orient.DEFAULT_ORIENTATION)), (0, _operators.catchError)(error => {
