...
class BlockEditor extends _react.default.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "renderPortal", children => {
    ...
    this.blockEditorRef = _react.default.createRef();
  }
  ...
  render() {
    ...
    return _react.default.createElement(_default.default, {
      ...
      onClick: () => this.focus()
    }, "Jump to editor"), fullscreen ? this.renderPortal(_react.default.createElement(_scrollContainer.default, {
      className: _BlockEditor.default.portal,
