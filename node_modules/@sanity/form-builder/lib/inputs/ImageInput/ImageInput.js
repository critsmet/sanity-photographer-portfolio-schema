...
class ImageInput extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "renderMaterializedAsset", assetDocument => {
      ...
      const srcAspectRatio = (0, _get2.default)(assetDocument, 'metadata.dimensions.aspectRatio');
  ...
  render() {
    ...
    }, _react.default.createElement(_buttonCollection.default, null, !readOnly && _react.default.createElement(_button.default, {
