...
class ImageInput extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "renderMaterializedAsset", assetDocument => {
      ...
      return _react.default.createElement(_HotspotImage.default, {
        aspectRatio: "auto",
  ...
  render() {
    ...
    const _partition2 = (0, _partition4.default)(type.fields.filter(field => !HIDDEN_FIELDS.includes(field.name)), 'type.options.isHighlighted'),
    ...
    return _react.default.createElement(_UploadTargetFieldset.default, {
      ...
      hasFocus: hasFocus
    })), highlightedFields.length > 0 && _react.default.createElement("div", {
      ...
      kind: "simple"
    }, "Select from library"), showAdvancedEditButton && _react.default.createElement(_default.default, {
    ...
    }, "Remove")), isAdvancedEditOpen && this.renderAdvancedEdit(otherFields), isSelectAssetOpen && _react.default.createElement(_fullscreen.default, {
      title: "Select image",
