...
var _default = (0, _withValuePath.default)((0, _withDocument.default)((_temp = _class = class SlugInput extends _react.default.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleGenerateSlug", () => {
      ...
      const source = (0, _get2.default)(type, 'options.source');
  ...
  slugify(sourceValue) {
    ...
    const type = this.props.type;
    const slugify = (0, _get2.default)(type, 'options.slugify', defaultSlugify);
    return Promise.resolve(slugify(sourceValue, type));
  }

  componentWillReceiveProps(nextProps) {
    const document = nextProps.document; // Reset state if document is changed
