...
function withDocument(ComposedComponent) {
  ...
  return _temp = _class = class WithDocument extends _react.default.PureComponent {
    constructor(props, context) {
      ...
      const formBuilder = context.formBuilder;
      this.state = {
        document: formBuilder.getDocument()
      };
      this.unsubscribe = formBuilder.onPatch(({
        snapshot
      }) => {
  ...
  }, _defineProperty(_class, "displayName", `withDocument(${ComposedComponent.displayName || ComposedComponent.name})`), _defineProperty(_class, "contextTypes", {
