...
class Matcher {
  ...
  activeRecursives(probe) {
    return this.recursives.filter(descender => {
      const head = descender.head; // Constraints are always relevant
  ...
  static fromPath(jsonpath) {
    const descender = new _Descender.default(null, new _Expression.default((0, _parse.default)(jsonpath)));
