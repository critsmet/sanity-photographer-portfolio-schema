...
class Commit {
  ...
  squash(doc) {
    const result = _Mutation.default.squash(doc, this.mutations);
...
class BufferedDocument {
  ...
  set onConsistencyChanged(callback) {
    this.document.onConsistencyChanged = callback;
  }

  get onConsistencyChanged() {
  ...
  rebase() {
    ...
    const changed = !(0, _isEqual2.default)(this.LOCAL, oldLocal);
