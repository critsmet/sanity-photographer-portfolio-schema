...
function withDocument(Pane) {
  ...
  return _temp = _class = class WithDocumentType extends _react.default.PureComponent {
    ...
    render() {
      const type = this.state.type; // We already have a type from props, maintain prop referential identity
  ...
  }, _defineProperty(_class, "displayName", `withDocumentType(${Pane.displayName || Pane.name})`), _defineProperty(_class, "propTypes", {
