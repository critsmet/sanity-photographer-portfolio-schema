...
const settings = _settings.default.forNamespace('desk-tool');
...
var _default = (0, _router.withRouterHOC)((_temp = _class = class DocumentsListPane extends _react.default.PureComponent {
  constructor(props) {
    ...
    const settingsNamespace = settings.forNamespace(_typeName);
  ...
  render() {
    ...
    return _react.default.createElement(_default3.default, {
      ...
      if (!loading && !hasItems(items)) {
        ...
        }, _react.default.createElement("div", null, _react.default.createElement("h3", null, filterIsSimpleTypeContraint ? 'No documents of this type found.' : 'No documents matching this filter found.'), typeName && _react.default.createElement(_default2.default, {
          color: "primary",
          icon: _plusIcon.default,
          onClick: this.handleCreateNew
        }, "New ", _schema.default.get(typeName).title)));
      }
