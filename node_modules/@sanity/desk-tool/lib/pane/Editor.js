...
_temp = _class = class Editor extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "renderActions", () => {
      ...
      }, _react.default.createElement(_chevronDownIcon.default, null)))), (0, _documentActionUtils.isActionEnabled)(type, 'publish') && !this.isLiveEditEnabled() && _react.default.createElement(_reactTippy.Tooltip, {
        arrow: true,
        theme: "light",
  ...
  render() {
    const _this$props9 = this.props,
          ...
          isPublishing = _this$props9.isPublishing,
          isUnpublishing = _this$props9.isUnpublishing,
          isCreatingDraft = _this$props9.isCreatingDraft,
          isReconnecting = _this$props9.isReconnecting,
          patchChannel = _this$props9.patchChannel,
          transactionResult = _this$props9.transactionResult,
          onClearTransactionResult = _this$props9.onClearTransactionResult;
    ...
    const enabledActions = (0, _documentActionUtils.resolveEnabledActions)(type);
