...
_temp = _class = class Editor extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "renderPublishInfo", () => {
      ...
      }, _react.default.createElement("strong", null, "Are you sure"), " you want to discard all changes since last published?"), _react.default.createElement(_buttonCollection.default, null, _react.default.createElement(_default2.default, {
        kind: "simple",
  ...
  getTitle(value) {
    ...
    return _react.default.createElement(_preview.PreviewFields, {
      ...
      title
    }) => title ? _react.default.createElement("span", null, title) : _react.default.createElement("em", null, "Untitled"));
  }
  ...
  render() {
    const _this$props10 = this.props,
          ...
          isPublishing = _this$props10.isPublishing,
          isUnpublishing = _this$props10.isUnpublishing,
          isCreatingDraft = _this$props10.isCreatingDraft,
