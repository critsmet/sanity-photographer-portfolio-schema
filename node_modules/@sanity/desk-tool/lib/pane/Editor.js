...
var _ConfirmDiscard = _interopRequireDefault(require("../components/ConfirmDiscard"));
...
const preventDefault = ev => ev.preventDefault(); // Want a nicer api for listen/unlisten
...
const getInspectItem = (draft, published) => ({
  action: 'inspect',
  title: _react.default.createElement("span", null, "Inspect ", _react.default.createElement("code", {
...
const getProductionPreviewItem = (draft, published) => {
  ...
  return previewUrl && {
    ...
    title: _react.default.createElement("span", null, "Open preview ", _react.default.createElement("code", {
      className: _Editor.default.hotkey
    }, "Ctrl+Alt+O")),
...
const getMenuItems = (draft, published, isLiveEditEnabled) => [getProductionPreviewItem, getDiscardItem, getUnpublishItem, getDuplicateItem, getInspectItem, getDeleteItem].map(fn => fn(draft, published, isLiveEditEnabled)).filter(Boolean);
...
_temp = _class = class Editor extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "handleCreateCopy", () => {
      ...
      const prevId = (0, _draftUtils.getPublishedId)((draft || published)._id);
      this.duplicate$ = _document.default.create((0, _draftUtils.newDraftFrom)((0, _copyDocument.default)(draft || published))).subscribe(copied => {
        const copyDocId = (0, _draftUtils.getPublishedId)(copied._id);
        const newPanes = router.state.panes.map((prev, i) => i === paneIndex - 1 && prev === prevId ? copyDocId : prev);
    ...
    _defineProperty(this, "renderActions", () => {
      ...
      }, _react.default.createElement(_checkIcon.default, null), " Synced"), (errors.length > 0 || warnings.length > 0) && _react.default.createElement(_reactTippy.Tooltip, {
        arrow: true,
      ...
      }, _react.default.createElement(_chevronDownIcon.default, null)))), !this.isLiveEditEnabled() && _react.default.createElement(_reactTippy.Tooltip, {
        arrow: true,
        theme: "light",
        className: _Editor.default.publishButton,
        title: errors.length > 0 ? 'Fix errors before publishing' : `${published ? 'Publish changes' : 'Publish'} (Ctrl+Alt+P)`
      }, _react.default.createElement(_default2.default, {
  ...
  isLiveEditEnabled() {
    const selectedSchemaType = _schema.default.get(this.props.type.name);
  ...
  render() {
    const _this$props8 = this.props,
          ...
          isPublishing = _this$props8.isPublishing,
          isUnpublishing = _this$props8.isUnpublishing,
          isCreatingDraft = _this$props8.isCreatingDraft,
          isReconnecting = _this$props8.isReconnecting,
          patchChannel = _this$props8.patchChannel,
          transactionResult = _this$props8.transactionResult,
          onClearTransactionResult = _this$props8.onClearTransactionResult;
    const _this$state2 = this.state,
          inspect = _this$state2.inspect,
          focusPath = _this$state2.focusPath,
          showConfirmDelete = _this$state2.showConfirmDelete,
          showConfirmDiscard = _this$state2.showConfirmDiscard,
    ...
    return _react.default.createElement(_default3.default, {
      ...
      className: _Editor.default.root
    }, (isCreatingDraft || isPublishing || isUnpublishing) && _react.default.createElement("div", {
      ...
      className: _Editor.default.editedDate
    }, value && _react.default.createElement("span", null, "Edited ", _react.default.createElement(_TimeAgo.default, {
      time: value._updatedAt
    }))), !this.isLiveEditEnabled() && _react.default.createElement("div", {
      className: _Editor.default.publishedDate
    }, published ? _react.default.createElement("span", null, "Published ", _react.default.createElement(_TimeAgo.default, {
      time: published._updatedAt
    })) : 'Not published')), _react.default.createElement("form", {
    ...
    }), showConfirmDiscard && _react.default.createElement(_ConfirmDiscard.default, {
      draft: draft,
      published: published,
