...
var _default = (0, _withDocumentType.default)((_temp = _class = class EditorPane extends _react.default.Component {
  constructor(props) {
    ...
    _asyncToGenerator(function* () {
      ...
      const type = _schema.default.get(doc._type);
      ...
      const markers = yield (0, _validation.validateDocument)(doc, _schema.default);
    ...
    _defineProperty(this, "handleDelete", () => {
      ...
      const tx = _client.default.observable.transaction().delete((0, _draftUtils.getPublishedId)(documentId)).delete((0, _draftUtils.getDraftId)(documentId));
    ...
    _defineProperty(this, "handleUnpublish", () => {
      ...
      let tx = _client.default.observable.transaction().delete((0, _draftUtils.getPublishedId)(documentId));
    ...
    _defineProperty(this, "handlePublish", () => {
      ...
      const tx = _client.default.observable.transaction();
    ...
    _defineProperty(this, "setStateIfMounted", (...args) => {
      if (!this._isMounted) {
        return;
      }
  ...
  setup(documentId) {
    ...
    const _checkoutPair = (0, _formBuilder.checkoutPair)({
      publishedId,
      draftId
    }),
    ...
    const draft$ = this.draft.events.pipe((0, _operators.tap)(this.receiveDraftEvent));
    this.subscription = (0, _rxjs.merge)(published$.pipe((0, _operators.map)(event => _objectSpread({}, event, {
      ...
      version: 'draft'
    })))).pipe((0, _operators.catchError)((err, _caught$) => {
      // eslint-disable-next-line no-console
      console.error(err);
      return (0, _rxjs.of)({
        type: 'error',
  ...
  isLiveEditEnabled() {
    const selectedSchemaType = _schema.default.get(this.props.options.type);
  ...
  renderError(error) {
    ...
    }, _react.default.createElement("h3", null, "We're", " sorry, but an error occurred"), _react.default.createElement("div", null, error.message), _react.default.createElement(_default2.default, {
