...
var _default = (0, _router.withRouterHOC)((_temp = _class = class ListPane extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "shouldShowIconForItem", item => {
      ...
      const itemShowIcon = item.displayOptions && item.displayOptions.showIcon; // Specific true/false on item should have presedence over list setting
  ...
  render() {
    ...
    }, items.map(item => _react.default.createElement(_PaneItem.default, {
      key: item.id,
      id: item.id,
      index: index,
      value: item,
