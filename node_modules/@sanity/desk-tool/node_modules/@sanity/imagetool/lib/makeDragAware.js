...
function makeDragAware(Component) {
  ...
  function (_React$PureComponent) {
    ...
    function DragAware() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "currentPos", null);
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDrag", function (event) {
        if (!_this.isDragging) {
          return;
        }
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDragCancel", function (event) {
        if (!_this.isDragging) {
          return;
        }
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setDomNode", function (node) {
        _this.domNode = node;
      });
