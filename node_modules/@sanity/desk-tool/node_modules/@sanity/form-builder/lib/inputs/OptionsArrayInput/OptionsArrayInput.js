...
class OptionsArrayInput extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "handleChange", (isChecked, optionValue) => {
      ...
      const list = (0, _get2.default)(type.options, 'list');
  ...
  render() {
    ...
    const options = (0, _get2.default)(type.options, 'list');
    const direction = (0, _get2.default)(type.options, 'direction'); // vertical and horizontal
