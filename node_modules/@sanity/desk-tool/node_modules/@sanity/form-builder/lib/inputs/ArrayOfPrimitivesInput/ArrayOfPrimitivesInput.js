...
class ArrayOfPrimitivesInput extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "renderItem", (item, index) => {
      ...
      const isSortable = (0, _get2.default)(type, 'options.sortable') !== false;
  ...
  removeAt(index) {
    const _this$props$value2 = this.props.value,
  ...
  render() {
    ...
    return _react.default.createElement(_default2.default, {
      ...
      className: _ArrayOfPrimitivesInput.default.list
    }, value && value.length > 0 && this.renderList(value)), _react.default.createElement("div", {
