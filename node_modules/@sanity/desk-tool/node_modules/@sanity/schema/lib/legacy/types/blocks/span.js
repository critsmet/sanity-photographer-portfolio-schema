...
const SpanType = {
  ...
  extend(subTypeDef, extendMember) {
    ...
    const _subTypeDef$fields = subTypeDef.fields,
          fields = _subTypeDef$fields === void 0 ? [] : _subTypeDef$fields,
    ...
    const parsed = Object.assign((0, _pick2.default)(SPAN_CORE, INHERITED_FIELDS), subTypeDef, {
      type: SPAN_CORE,
      options: options
    });
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, (0, _pick2.default)(extensionDef, INHERITED_FIELDS), {
            type: parent
          });
