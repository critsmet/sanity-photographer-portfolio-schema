...
function SanityStatus(props) {
  ...
  const className = `${_SanityStatus.default.root} ${_SanityStatus.default[severity]}`;
  const Dialog = isUpToDate ? _CurrentVersionsDialog.default : _UpdateNotifierDialog.default;
  return _react.default.createElement("div", {
    className: className
  }, showDialog && _react.default.createElement(Dialog, {
    severity: severity,
    outdated: outdated,
    ...
    tabIndex: -1
  }, isUpToDate ? _react.default.createElement("span", null, "Up to date") : _react.default.createElement("span", null, _react.default.createElement(_packageIcon.default, null), " ", formatUpdateLabel(outdated.length)))));
}
