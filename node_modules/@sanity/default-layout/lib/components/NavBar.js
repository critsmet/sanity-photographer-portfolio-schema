...
function NavBar(props) {
  const searchIsOpen = props.searchIsOpen,
  ...
  let searchClassName = _NavBar.default.search;
  if (searchIsOpen) searchClassName += ` ${_NavBar.default.searchIsOpen}`;
  let className = _NavBar.default.root;
  if (showToolSwitcher) className += ` ${_NavBar.default.withToolSwitcher}`;
