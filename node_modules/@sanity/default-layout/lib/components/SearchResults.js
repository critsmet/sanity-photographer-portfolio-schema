  ...
  render() {
    ...
    if (noResults) {
      return _react.default.createElement("div", {
        className: `${_SearchResults.default.root} ${_SearchResults.default.noResults}`
      }, _react.default.createElement("div", null, "Could not find", ' ', _react.default.createElement("strong", null, "\u201C", query, "\u201D")));
    }

    if (isLoading) {
      return _react.default.createElement("div", {
        className: `${_SearchResults.default.root} ${_SearchResults.default.isLoading}`
