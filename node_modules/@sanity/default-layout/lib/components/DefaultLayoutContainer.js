...
class DefaultLayoutContainer extends _react.default.PureComponent {
  ...
  render() {
    ...
    const content = isNotFound ? _react.default.createElement(_NotFound.default, null, intent && _react.default.createElement("div", null, "No tool can handle the intent: ", _react.default.createElement("strong", null, intent.name), " with parameters", ' ', _react.default.createElement("pre", null, JSON.stringify(intent.params)))) : _react.default.createElement(_DefaultLayout.default, {
      tools: tools
    });

    const router = _react.default.createElement(_router.RouterProvider, {
