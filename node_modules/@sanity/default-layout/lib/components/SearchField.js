...
class SearchField extends _react.default.PureComponent {
  ...
  render() {
    ...
    let className = _SearchField.default.root;
    if (isBleeding) className += ` ${_SearchField.default.isBleeding}`;
    if (isFocused) className += ` ${_SearchField.default.isFocused}`;
    if (isOpen) className += ` ${_SearchField.default.isOpen}`;
    if (value.length) className += ` ${_SearchField.default.hasValue}`;
