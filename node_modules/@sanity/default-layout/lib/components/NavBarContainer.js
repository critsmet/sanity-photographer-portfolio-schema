...
class NavBarContainer extends _react.default.PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const didShowToolSwitcher = showToolSwitcherMinWidth === -1 && !prevState.showToolSwitcher && showToolSwitcher;
  ...
  handleCustomResize(winWidth) {
    if (this.loginStatusElement) {
      const showToolSwitcher = this.state.showToolSwitcher; // console.log(this.searchElement)

      const mostRightRect = showToolSwitcher ? this.loginStatusElement.getBoundingClientRect() : this.searchElement.getBoundingClientRect();
      this.setState(state => {
        const nextState = getNextState(state, mostRightRect.left + mostRightRect.width, winWidth); // console.log(nextState)
