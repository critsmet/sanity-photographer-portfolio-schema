...
const imageBuilder = (0, _imageUrl.default)(_client.default);
...
class SanityDefaultPreview extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "renderMedia", options => {
      ...
      const media = value.media; // Handle sanity image
    ...
    _defineProperty(this, "renderImageUrl", options => {
      ...
      if (imageUrl) {
        const assetUrl = (0, _assetUrlBuilder.default)(imageUrl.split('?')[0], dimensions);
        return _react.default.createElement("img", {
          src: assetUrl,
          alt: value.title
        });
  ...
  render() {
    const _this$props = this.props,
          ...
          _renderAsBlockImage = _this$props._renderAsBlockImage,
          rest = _objectWithoutProperties(_this$props, ["layout", "_renderAsBlockImage"]);
    ...
    const _extractUploadState = extractUploadState(this.props.value),
          _upload = _extractUploadState._upload,
          value = _extractUploadState.value;

    const item = _upload ? _objectSpread({}, value, {
