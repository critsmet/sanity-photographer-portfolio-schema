...
"use strict";var generateHelpUrl=require("@sanity/generate-help-url"),assign=require("object-assign"),validate=require("./validators"),defaultCdnHost="apicdn.sanity.io",defaultConfig={apiHost:"https://api.sanity.io",useProjectHostname:!0,gradientMode:!1,isPromiseAPI:!0},cdnWarning=["You are not using the Sanity CDN. That means your data is always fresh, but the CDN is faster and","cheaper. Think about it! For more info, see ".concat(generateHelpUrl("js-client-cdn-configuration"),"."),"To hide this warning, please set the `useCdn` option to either `true` or `false` when creating","the client."],cdnTokenWarning=["You have set `useCdn` to `true` while also specifying a token. This is usually not what you","want. The CDN cannot be used with an authorization token, since private data cannot be cached.","See ".concat(generateHelpUrl("js-client-usecdn-token")," for more information.")],hasWarned={},printWarning=function(e,n){hasWarned[e]||(console.warn(n),hasWarned[e]=!0)};exports.defaultConfig=defaultConfig,exports.initConfig=function(e,n){var t=assign({},defaultConfig,n,e),a=t.gradientMode,o=!a&&t.useProjectHostname;if("undefined"==typeof Promise){var i=generateHelpUrl("js-client-promise-polyfill");throw new Error("No native Promise-implementation found, polyfill needed - see ".concat(i))}if(a&&!t.namespace)throw new Error("Configuration must contain `namespace` when running in gradient mode");if(o&&!t.projectId)throw new Error("Configuration must contain `projectId`");if(void 0!==t.useCdn||t.token?t.useCdn&&t.token&&("undefined"==typeof window||-1!==["localhost","127.0.0.1","0.0.0.0"].indexOf(window.location.hostname))&&printWarning("cdn-token",cdnTokenWarning.join(" ")):printWarning("cdn",cdnWarning.join(" ")),o&&validate.projectId(t.projectId),!a&&t.dataset&&validate.dataset(t.dataset,t.gradientMode),t.isDefaultApi=t.apiHost===defaultConfig.apiHost,t.useCdn=Boolean(t.useCdn)&&!t.token&&!t.withCredentials,t.gradientMode)t.url=t.apiHost,t.cdnUrl=t.apiHost;else{var r=t.apiHost.split("://",2),s=r[0],d=r[1],c=t.isDefaultApi?defaultCdnHost:d;t.useProjectHostname?(t.url="".concat(s,"://").concat(t.projectId,".").concat(d,"/v1"),t.cdnUrl="".concat(s,"://").concat(t.projectId,".").concat(c,"/v1")):(t.url="".concat(t.apiHost,"/v1"),t.cdnUrl=t.url)}return t};

},{"./validators":78,"@sanity/generate-help-url":80,"object-assign":23}],60:[function(require,module,exports){
